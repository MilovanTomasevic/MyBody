...
#import "MTFansyTextView.h"

#define UI_FLOAT_LABEL_VERTICAL_INSET_OFFSET    8.0f


@interface MTFansyTextView ()
...
@implementation MTFansyTextView
...
-(void)customizeFansyTextView:(MTFansyTextView*)textView withView:(UIView*)view andPlaceholder:(NSString*)placeholder{
    ...
    textView.floatLabelActiveColor = [THEME_MANAGER getAccentColor];
    textView.floatLabelPassiveColor = [UIColor lightGrayColor];
    textView.layer.borderColor = [[THEME_MANAGER getAccentColor] CGColor];
    textView.font = [UIFont systemFontOfSize:19.0f];
    textView.floatLabel.font = [UIFont systemFontOfSize:12.0f];
    textView.backgroundColor = [THEME_MANAGER getTextColor];
