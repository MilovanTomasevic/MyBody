...
#import "MTFansyTextField.h"

@interface MTFansyTextField ()
...
@implementation MTFansyTextField
...
-(void)customizeFansyField:(MTFansyTextField*)field withView:(UIView*)view andPlaceholder:(NSString*)placeholder border:(BOOL)border radius:(BOOL)radius changeColoc:(BOOL)change{
    
    field.floatLabelActiveColor = [UIColor orangeColor];
...
-(void)textFieldDidChange:(MTFansyTextField *)theTextField{
...
- (BOOL)textFieldShouldReturn:(MTFansyTextField *)textField{
    [textField resignFirstResponder];
    return YES;
}

//-(BOOL)textField:(MTFansyTextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string {
...
-(BOOL)textFieldShouldClear:(MTFansyTextField *)textField {
    textField.hidden = NO;
    textField.text = @"";
    textField.backgroundColor = [UIColor whiteColor];
    return YES;
