...
-(void)setLabelFont:(UIFont *)alabelFont
{
...
-(void)setDetailsLabelFont:(UIFont *)adetailsLabelFont
{
    [self willChangeValueForKey:@"detailsLabelFont"];
    detailsLabelFont = adetailsLabelFont;
    [self didChangeValueForKey:@"detailsLabelFont"];
}
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        detailsLabelFont = [UIFont boldSystemFontOfSize:kDetailsLabelFontSize];
