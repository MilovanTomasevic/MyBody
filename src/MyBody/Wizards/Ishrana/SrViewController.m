...
-(void)nextPage
{
    ...
    [masterVC.ishranaDB setSDorucak:self.tvDorucak.text];
    [masterVC.ishranaDB setSUzina:self.tvUzina.text];
    [masterVC.ishranaDB setSRucak:self.tvRucak.text];
    [masterVC.ishranaDB setSUzina2:self.tvUzina2.text];
    [masterVC.ishranaDB setSVecera:self.tvVecera.text];
    
    LogI(@" setovana ishrana za sredu:   %@", masterVC.ishranaDB.sDorucak);
    LogI(@" setovana ishrana za sredu:   %@", masterVC.ishranaDB.sUzina);
    LogI(@" setovana ishrana za sredu:   %@", masterVC.ishranaDB.sRucak);
    LogI(@" setovana ishrana za sredu:   %@", masterVC.ishranaDB.sUzina2);
    LogI(@" setovana ishrana za sredu:   %@", masterVC.ishranaDB.sVecera);
